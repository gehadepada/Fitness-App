...
fun SearchView(state: MutableState<TextFieldValue>) {
    TextField(
        ...
        colors = TextFieldDefaults.textFieldColors(
            backgroundColor = Color(color = 0xADF6F6F6),
            focusedIndicatorColor = Color(color = 0xADF6F6F6),
            unfocusedIndicatorColor = Color(color = 0xADF6F6F6),
            disabledIndicatorColor = Color(color = 0xADF6F6F6)
        )
    )
}
